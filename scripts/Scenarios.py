...
MAX_SEPARATION_DISTANCE_DEFAULT = 100000
HYDRANT_REFILL_PROBABILITY = "HYDRANT_REFILL_PROBABILITY"
HYDRANT_REFILL_PROBABILITY_DEFAULT = 0.5
...
scenarios.append({SCENARIO_NAME:"H3 p=0.1 deg=1",
                  H1_INTRODUCE_FAILURE:False,
                  H2_INTRODUCE_FAILURE:False,
                  H3_MECHANISM:True,
                  H3_DEGREE:1,
